...
#         pass
    ...
    def configure_optimizers(self):
        ...
        optim = torch.optim.Adam(list(self.encoder.parameters()) + list(self.decoder.parameters()),self.hparams["learning_rate"])
...
class Classifier(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # TODO: Define your optimizer.                                         #
        ########################################################################
        optim = torch.optim.Adam(list(self.encoder.parameters()) + list(self.model.parameters()),self.hparams["learning_rate"])
